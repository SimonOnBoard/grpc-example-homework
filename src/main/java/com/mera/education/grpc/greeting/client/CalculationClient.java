...
import com.mera.education.grpc.proto.calculation.CalculationServiceGrpc;
import com.mera.education.grpc.proto.calculation.NumberRequest;
import com.mera.education.grpc.proto.calculation.NumberResponse;
...
//        logger.debug("Shutting down channel");
    ...
    private void doServerStreamingCall(ManagedChannel channel) {
        ...
        calculationServiceFutureStub.getDivisors(com.mera.education.grpc.proto.calculation.NumberRequest.newBuilder().setNumber(40).build())
    ...
    private void doClientStreamingCall(ManagedChannel channel) {
        ...
        Arrays.asList(2, 4, 4, 4, 5, 5, 7, 9)
                .forEach(number -> streamObserver.onNext(com.mera.education.grpc.proto.calculation.NumberRequest.newBuilder().setNumber(number).build()));
    ...
    private void doBiDiStreamingCall(ManagedChannel channel) {
        ...
        Arrays.asList(-5d, 4d, 3d).forEach(
                number -> {
                    ...
                    serverDataObserver.onNext(com.mera.education.grpc.proto.calculation.NumberRequest.newBuilder().setNumber(number).build());
